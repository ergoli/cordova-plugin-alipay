...
- (void) pay:(CDVInvokedUrlCommand*)command
{
    ...
    NSString *args = [command argumentAtIndex:0];


    [[AlipaySDK defaultService] payOrder:args fromScheme:[NSString stringWithFormat:@"a%@", self.partner] callback:^(NSDictionary *resultDic) {
